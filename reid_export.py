...
from yolov7.utils.general import LOGGER, colorstr, check_requirements, check_version
...
def export_torchscript(model, im, file, optimize, prefix=colorstr('TorchScript:')):
    # YOLOv7 TorchScript model export
    try:
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Yolov7 StrongSORT OSNet export")
